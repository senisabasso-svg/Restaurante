...
import { View, Text, ScrollView, TextInput, TouchableOpacity, Alert, StyleSheet, Image } from 'react-native';
...
import { createOrder, getBusinessStatus } from '../services/api';
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.formCard, dynamicStyles.formCard]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            disabled={!businessStatus.isOpen || !businessStatus.isWithinHours}
            style={[
              styles.submitButtonContainer,
              (!businessStatus.isOpen || !businessStatus.isWithinHours) && styles.submitButtonDisabled
            ]}
          >
            <LinearGradient
              colors={(!businessStatus.isOpen || !businessStatus.isWithinHours) 
                ? ['#9ca3af', '#6b7280'] 
                : ['#ea580c', '#f97316']}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 0 }}
